...
internal static partial class TestRunner
{
    private static readonly (string Name, Func<bool> Run)[] Tests =
    {
        ...
        ("World_Storage_RackStartsWithTwoOfEachStarterItemAcrossTwoShelves", World_Storage_RackStartsWithTwoOfEachStarterItemAcrossTwoShelves),
        ("World_Storage_RackStartsWithTwoOfEachMaterial", World_Storage_RackStartsWithTwoOfEachMaterial),
        ("World_Autopilot_ReachesDestinationAndStops", World_Autopilot_ReachesDestinationAndStops),
        ("World_Autopilot_AvoidsAsteroidInPath", World_Autopilot_AvoidsAsteroidInPath),
        ("World_Autopilot_FacingOverrideDivergesFromTravel", World_Autopilot_FacingOverrideDivergesFromTravel),
        ("World_Autopilot_StopCancelsEarly", World_Autopilot_StopCancelsEarly),
        ...
        ("World_RoomHp_LargeBreachInRoom_KillsUnsuitedCharacterLikeEva", World_RoomHp_LargeBreachInRoom_KillsUnsuitedCharacterLikeEva),
        ("World_RoomHp_SmallPinholeBreach_DoesNotKillUnsuitedCharacterLikeALargeOne", World_RoomHp_SmallPinholeBreach_DoesNotKillUnsuitedCharacterLikeALargeOne),
        ("World_DeadCharacter_CannotMove", World_DeadCharacter_CannotMove),
        ("World_DeadCharacter_CannotToggleDoors", World_DeadCharacter_CannotToggleDoors),
        ("World_DeadCharacter_StaysSeatedAtTurretRatherThanBeingEjected", World_DeadCharacter_StaysSeatedAtTurretRatherThanBeingEjected),
        ("World_DeadCharacter_RespawnsAfterTenSeconds", World_DeadCharacter_RespawnsAfterTenSeconds),
        ...
        ("World_ShipDebris_DestroyingRoomWithChainedNeighbor_DetachesBothIndirectly", World_ShipDebris_DestroyingRoomWithChainedNeighbor_DetachesBothIndirectly),
        ...
        ("World_ContentCatalog_EngineRoom_BuildsAWorkingEngine", World_ContentCatalog_EngineRoom_BuildsAWorkingEngine),
        ("World_ContentCatalog_EngineRoom_SurvivesBuildingAnotherRoomAfterward", World_ContentCatalog_EngineRoom_SurvivesBuildingAnotherRoomAfterward),
        ("World_ContentCatalog_Rcs1Way_BuildsAWorkingEngine", World_ContentCatalog_Rcs1Way_BuildsAWorkingEngine),
        ...
        ("World_MoveAlongAxis_WhileDocked_BlocksAtTileWallNotOldZeroWidthEdge", World_MoveAlongAxis_WhileDocked_BlocksAtTileWallNotOldZeroWidthEdge),
        ...
        ("Coop_Lobby_HostStartsRoundAfterPlayersJoinAndSetRoles", Coop_Lobby_HostStartsRoundAfterPlayersJoinAndSetRoles),
        ("Coop_Lobby_NonHostCannotStartRound", Coop_Lobby_NonHostCannotStartRound),
        ("Coop_NetworkHost_RejectsJoinerPastMaxPlayers", Coop_NetworkHost_RejectsJoinerPastMaxPlayers),
        ("Achievements_UnlockOnceAndPersistsAcrossTrackerInstances", Achievements_UnlockOnceAndPersistsAcrossTrackerInstances),
        ("Achievements_ToastQueueShowsOneAtATime", Achievements_ToastQueueShowsOneAtATime),
        ("Achievements_FirstDock_RequiresHavingLeftFirst", Achievements_FirstDock_RequiresHavingLeftFirst),
        ("Achievements_Boarding_IsNotAlwaysTrueFromTemplateRooms", Achievements_Boarding_IsNotAlwaysTrueFromTemplateRooms),
        ("Achievements_CatalogHasNoDuplicateIds", Achievements_CatalogHasNoDuplicateIds),
        ...
        ("World_CardGame_TwoPlayersAtTableOffersAChoiceButDoesNotAutoStart", World_CardGame_TwoPlayersAtTableOffersAChoiceButDoesNotAutoStart),
        ("World_CardGame_OnePlayerChoosingDurakAloneDoesNotStartIt", World_CardGame_OnePlayerChoosingDurakAloneDoesNotStartIt),
        ("World_CardGame_BothPlayersChoosingDurakStartsAHand", World_CardGame_BothPlayersChoosingDurakStartsAHand),
        ("World_CardGame_WalkingAwayClearsAPendingDurakVote", World_CardGame_WalkingAwayClearsAPendingDurakVote),
        ("World_CardGame_OnlyOnePlayerAtTableCannotStartDurak", World_CardGame_OnlyOnePlayerAtTableCannotStartDurak),
        ("World_CardGame_WalkingAwayCancelsTheHand", World_CardGame_WalkingAwayCancelsTheHand),
        ("World_FrontsGame_ChoosingFrontsStartsAMatch", World_FrontsGame_ChoosingFrontsStartsAMatch),
        ("World_FrontsGame_OutcommittingAFrontPushesItAndResetsAllocationsAfterResolve", World_FrontsGame_OutcommittingAFrontPushesItAndResetsAllocationsAfterResolve),
        ("World_FrontsGame_CapturingAFrontLocksItAgainstFurtherAllocation", World_FrontsGame_CapturingAFrontLocksItAgainstFurtherAllocation),
        ("World_FrontsGame_SweepingAllThreeFrontsDeclaresTheSweepingSideTheWinner", World_FrontsGame_SweepingAllThreeFrontsDeclaresTheSweepingSideTheWinner),
        ("World_FrontsGame_WalkingAwayCancelsTheMatch", World_FrontsGame_WalkingAwayCancelsTheMatch),
        ("World_FrontsGame_SoloPlayerChoosingFrontsStartsAMatchAgainstABot", World_FrontsGame_SoloPlayerChoosingFrontsStartsAMatchAgainstABot),
        ("World_FrontsGame_SoloPlayerChoosingDurakDoesNothing", World_FrontsGame_SoloPlayerChoosingDurakDoesNothing),
        ("World_FrontsGame_BotConcentratesOnThePlayersWeakestFront", World_FrontsGame_BotConcentratesOnThePlayersWeakestFront),
        ...
        ("CustomShip_World_ZeroAirlocks_DoesNotCrashOnConstructionOrDocking", CustomShip_World_ZeroAirlocks_DoesNotCrashOnConstructionOrDocking),
        ("CustomShip_FromDefinition_BuildsDecorativeDevicesForOtherwiseUnhandledKinds", CustomShip_FromDefinition_BuildsDecorativeDevicesForOtherwiseUnhandledKinds),
        ...
        ("World_Cameras_DefaultHullHasWorkingCameraGeometry", World_Cameras_DefaultHullHasWorkingCameraGeometry),
        ...
        ("Station_Procedural_OrientsAwayFromShipHullOnEverySide", Station_Procedural_OrientsAwayFromShipHullOnEverySide),
        ...
        ("TileGrid_WallDeviceRequiresAdjacentWallAndFullyBlocksItsOwnTile", TileGrid_WallDeviceRequiresAdjacentWallAndFullyBlocksItsOwnTile),
        ("TileGrid_WallDevice_RefusesProtrudingOntoAHalfThickWallNeighbor", TileGrid_WallDevice_RefusesProtrudingOntoAHalfThickWallNeighbor),
        ("TileGrid_WallDevice_RejectsKindsOtherThanTerminalOrWallLamp", TileGrid_WallDevice_RejectsKindsOtherThanTerminalOrWallLamp),
        ...
        ("TileGrid_HalfThickWall_SolidHalfBlockedFreeHalfWalkable", TileGrid_HalfThickWall_SolidHalfBlockedFreeHalfWalkable),
        ("TileGrid_CornerWall_StaysFullyBlockedAtEveryPosition", TileGrid_CornerWall_StaysFullyBlockedAtEveryPosition),
        ("TileGrid_PlaceRecessedTerminal_RequiresNonCornerWallAndThenBlocksWholeTile", TileGrid_PlaceRecessedTerminal_RequiresNonCornerWallAndThenBlocksWholeTile),
        ("TileGrid_DoorEdge_RequiresAtLeastOneFlankingTileAlreadyFreeFloor", TileGrid_DoorEdge_RequiresAtLeastOneFlankingTileAlreadyFreeFloor),
        ("TileGrid_DoorEdge_AllowsSpaceOnTheAnchorSideToo", TileGrid_DoorEdge_AllowsSpaceOnTheAnchorSideToo),
        ("World_DoorEdge_ExteriorEdgeGetsNullRoomIdOnTheVacuumSideAndLeaksOxygenWhenOpen", World_DoorEdge_ExteriorEdgeGetsNullRoomIdOnTheVacuumSideAndLeaksOxygenWhenOpen),
        ("World_DoorEdge_VacuumAirlock_LetsCrewWalkAboardTheStation", World_DoorEdge_VacuumAirlock_LetsCrewWalkAboardTheStation),
        ("World_DoorEdge_VacuumAirlock_ClosedToSpace_WhileDocked_DoesNotLeak", World_DoorEdge_VacuumAirlock_ClosedToSpace_WhileDocked_DoesNotLeak),
        ("TileGrid_DoorEdge_SplitsRegionThenRemovalMergesItBack", TileGrid_DoorEdge_SplitsRegionThenRemovalMergesItBack),
        ("TileGrid_DoorEdge_OpenOrClosedNeverChangesTopology_OnlyBreachDoes", TileGrid_DoorEdge_OpenOrClosedNeverChangesTopology_OnlyBreachDoes),
        ("TileGrid_DoorEdge_LoopWithAnotherPathAround_DoesNotSplitRegion", TileGrid_DoorEdge_LoopWithAnotherPathAround_DoesNotSplitRegion),
        ("TileGrid_DoorEdge_CanonicalizesRegardlessOfWhichSideItsAskedFrom", TileGrid_DoorEdge_CanonicalizesRegardlessOfWhichSideItsAskedFrom),
        ("TileMovement_BlocksMovementAcrossClosedDoorEdge_AllowsWhenOpenOrBreached", TileMovement_BlocksMovementAcrossClosedDoorEdge_AllowsWhenOpenOrBreached),
        ("TileGrid_DoorEdge_RemovedWhenFlankingFloorIsErased", TileGrid_DoorEdge_RemovedWhenFlankingFloorIsErased),
        ("TileGrid_DoorEdge_RemovedWhenFlankingTileBecomesAWall", TileGrid_DoorEdge_RemovedWhenFlankingTileBecomesAWall),
        ("World_DoorEdge_ServerAndClientAgreeOnCollisionAndOcclusion", World_DoorEdge_ServerAndClientAgreeOnCollisionAndOcclusion),
        ("TileGrid_DoorEdge_WideDoor_BothParallelEdgesNeededToSplitRegion", TileGrid_DoorEdge_WideDoor_BothParallelEdgesNeededToSplitRegion),
        ("World_DoorEdge_WideDoor_TwoSegmentsShareIdAndToggleTogether", World_DoorEdge_WideDoor_TwoSegmentsShareIdAndToggleTogether),
        ("TileGrid_DoorEdge_TripleDoor_AllThreeParallelEdgesNeededToSplitRegion", TileGrid_DoorEdge_TripleDoor_AllThreeParallelEdgesNeededToSplitRegion),
        ("World_DoorEdge_TripleDoor_ThreeSegmentsShareIdAndToggleTogether", World_DoorEdge_TripleDoor_ThreeSegmentsShareIdAndToggleTogether),
        ("TileMovement_MoveAlongAxis_WalksIntoHalfThickWallsFreeHalf", TileMovement_MoveAlongAxis_WalksIntoHalfThickWallsFreeHalf),
        ("TileMovement_MoveAlongAxis_StillBlocksFullyAtACorner", TileMovement_MoveAlongAxis_StillBlocksFullyAtACorner),
        ("TileRegionConnectivity_DoorConnectsTwoRegions_BothReachableFromEachOther", TileRegionConnectivity_DoorConnectsTwoRegions_BothReachableFromEachOther),
        ("TileRegionConnectivity_DestroyingOneRoomsFloor_LeavesTheOtherRegionAloneAndUnreachable", TileRegionConnectivity_DestroyingOneRoomsFloor_LeavesTheOtherRegionAloneAndUnreachable),
        ("TileOccluders_IsolatedRoom_MatchesRoomRectangleOccluders", TileOccluders_IsolatedRoom_MatchesRoomRectangleOccluders),
        ("TileOccluders_OpenDoorTile_RemovesItsSpanFromTheWall", TileOccluders_OpenDoorTile_RemovesItsSpanFromTheWall),
        ("TileOccluders_LShapedRegion_TracesTheActualBoundaryNotABoundingRectangle", TileOccluders_LShapedRegion_TracesTheActualBoundaryNotABoundingRectangle),
        ("TileOccluders_GapCutsThroughAMergedMultiTileRun", TileOccluders_GapCutsThroughAMergedMultiTileRun),
        ("TileOccluders_HalfThickWall_OccludesOnlyItsOwnSolidHalf", TileOccluders_HalfThickWall_OccludesOnlyItsOwnSolidHalf),
        ("TileOccluders_HalfThickWallNextToFullCorner_StillOccludesTheExposedHalf", TileOccluders_HalfThickWallNextToFullCorner_StillOccludesTheExposedHalf),
        ("TileOccluders_WindowWall_DoesNotOccludeSightButOrdinaryWallStillDoes", TileOccluders_WindowWall_DoesNotOccludeSightButOrdinaryWallStillDoes),
        ("World_CustomShipWithWindow_ClientTilesTreatItAsNonOccluding", World_CustomShipWithWindow_ClientTilesTreatItAsNonOccluding),
        ("Ship_FromCustomDefinition_JunctionDevices_BecomeJunctionBoxes", Ship_FromCustomDefinition_JunctionDevices_BecomeJunctionBoxes),
        ("Ship_ToDefinition_RoundTripsJunctionBoxes", Ship_ToDefinition_RoundTripsJunctionBoxes),
        ("Ship_FromCustomDefinition_MultipleBatteryDevices_CountsAndTracksExtras", Ship_FromCustomDefinition_MultipleBatteryDevices_CountsAndTracksExtras),
        ("Ship_FromCustomDefinition_NoBatteryDevicePlaced_CountsAsOne", Ship_FromCustomDefinition_NoBatteryDevicePlaced_CountsAsOne),
        ("World_MultipleBatteryDevices_IncreasesPowerGridCapacity", World_MultipleBatteryDevices_IncreasesPowerGridCapacity),
        ("Ship_ToDefinition_RoundTripsExtraBatteryPositions", Ship_ToDefinition_RoundTripsExtraBatteryPositions),
        ("ClientTileGrid_Build_OverlaysLiveDoorOpenState", ClientTileGrid_Build_OverlaysLiveDoorOpenState),
        ("ClientTileGrid_OpenDoor_LeavesNoWallSegmentForTileOccludersToBlockSightWith", ClientTileGrid_OpenDoor_LeavesNoWallSegmentForTileOccludersToBlockSightWith),
        ("ClientTileGrid_ApplyLiveDoorState_AlsoWorksForStationTiles", ClientTileGrid_ApplyLiveDoorState_AlsoWorksForStationTiles),
        ("TileGridRasterizer_DoorTileRect_AlignsWithTheLeadingEdgeWallConvention", TileGridRasterizer_DoorTileRect_AlignsWithTheLeadingEdgeWallConvention),
        ("TileGridRasterizer_DefaultHull_OneRegionPerRoom", TileGridRasterizer_DefaultHull_OneRegionPerRoom),
        ...
        ("TileGridRasterizer_NeverInfersOpenSideAutomatically", TileGridRasterizer_NeverInfersOpenSideAutomatically),
        ...
        ("Ship_Engine_FromDefinition_ComputesTilePositionsAlongFacing", Ship_Engine_FromDefinition_ComputesTilePositionsAlongFacing),
        ("World_Engine_IsThrustingTracksLiveThrottleWhileIntact", World_Engine_IsThrustingTracksLiveThrottleWhileIntact),
        ("World_Engine_ControlBreak_FreezesThrottleUntilRepaired", World_Engine_ControlBreak_FreezesThrottleUntilRepaired),
        ("World_Engine_NozzleBreak_StopsThrustRegardlessOfThrottle", World_Engine_NozzleBreak_StopsThrustRegardlessOfThrottle),
        ("World_Engine_BulkheadBreach_LeaksRoomOxygen", World_Engine_BulkheadBreach_LeaksRoomOxygen),
        ("Ship_Engine_BulkheadPosition_ExcludesGeneratedWallBlock", Ship_Engine_BulkheadPosition_ExcludesGeneratedWallBlock),
        ("World_Engine_Welder_RepairsBulkhead", World_Engine_Welder_RepairsBulkhead),
        ("World_Engine_Wrench_RepairsControlViaMinigame", World_Engine_Wrench_RepairsControlViaMinigame),
        ("Ship_Engine_Rcs_FromDefinition_HasRcsRole", Ship_Engine_Rcs_FromDefinition_HasRcsRole),
        ("World_Engine_Rcs_ControlBreak_FreezesTurnUntilRepaired", World_Engine_Rcs_ControlBreak_FreezesTurnUntilRepaired),
        ("World_Engine_OffCenterEngine_InducesGrowingAngularVelocity", World_Engine_OffCenterEngine_InducesGrowingAngularVelocity),
        ("World_Engine_SymmetricEngines_ProduceNoNetRotation", World_Engine_SymmetricEngines_ProduceNoNetRotation),
        ("World_Engine_Stabilize_DecaysInducedAngularVelocity", World_Engine_Stabilize_DecaysInducedAngularVelocity),
        ("World_Engine_MisalignedFacing_DoesNotFireForThrottle", World_Engine_MisalignedFacing_DoesNotFireForThrottle),
        ("World_Engine_Strafe_FiresThePerpendicularEngine", World_Engine_Strafe_FiresThePerpendicularEngine),
        ("World_Engine_Rotation_OnlyTheHelpfulRcsEngineFires", World_Engine_Rotation_OnlyTheHelpfulRcsEngineFires),
        ("Ship_DoubleEngine_FromDefinition_SharesControlPositionWithTwoFacings", Ship_DoubleEngine_FromDefinition_SharesControlPositionWithTwoFacings),
        ("World_DoubleEngine_Throttle_FiresOnlyTheAlignedArm", World_DoubleEngine_Throttle_FiresOnlyTheAlignedArm),
        ("World_DoubleEngine_Strafe_FiresTheOtherArm", World_DoubleEngine_Strafe_FiresTheOtherArm),
        ("World_DoubleEngine_NozzleBreak_OnlyStopsThatArm", World_DoubleEngine_NozzleBreak_OnlyStopsThatArm),
        ("World_DoubleEngine_ControlBreak_OnlyFreezesThatArm", World_DoubleEngine_ControlBreak_OnlyFreezesThatArm),
        ("World_RoomHp_StartsAtMaxForEveryRoom", World_RoomHp_StartsAtMaxForEveryRoom),
        ("World_RoomHp_EngineBulkheadDamage_ReducesOnlyItsOwnRoom", World_RoomHp_EngineBulkheadDamage_ReducesOnlyItsOwnRoom),
        ("World_RoomHp_DoorDamage_ReducesBothBorderingRooms", World_RoomHp_DoorDamage_ReducesBothBorderingRooms),
        ("World_RoomHp_ReachingZero_ExplodesRoomAndDetachesOrphanedNeighbor", World_RoomHp_ReachingZero_ExplodesRoomAndDetachesOrphanedNeighbor),
        ("World_Chat_MessageAppearsInSnapshot", World_Chat_MessageAppearsInSnapshot),
        ("World_Chat_DefaultSenderNameIsPlayerIdFallback", World_Chat_DefaultSenderNameIsPlayerIdFallback),
        ("World_Chat_LogIsCappedAtMaxEntries", World_Chat_LogIsCappedAtMaxEntries),
        ("World_Chat_EmptyMessageIsIgnored", World_Chat_EmptyMessageIsIgnored),
        ("World_Voice_ChunkAppearsInSnapshotThenClears", World_Voice_ChunkAppearsInSnapshotThenClears),
        ("World_Voice_RadioFlagIsRelayed", World_Voice_RadioFlagIsRelayed),
        ("World_Voice_RadioWithoutItemIsDropped", World_Voice_RadioWithoutItemIsDropped),
        ...
        ("CompartmentPlacer_WallOverWallOverlap_IsRejected", CompartmentPlacer_WallOverWallOverlap_IsRejected),
        ("CompartmentPlacer_WallOverlappingAnotherRoomsInterior_IsRejected", CompartmentPlacer_WallOverlappingAnotherRoomsInterior_IsRejected),
        ("CustomDeviceFootprint_HelmAndNavigation_AreTwoByTwo", CustomDeviceFootprint_HelmAndNavigation_AreTwoByTwo),
        ("TileShipBuilder_UnrotatedConstructionBench_ExportsCenterUsingAuthoredWidthHeight", TileShipBuilder_UnrotatedConstructionBench_ExportsCenterUsingAuthoredWidthHeight),
        ("TileShipBuilder_RotatedConstructionBench_ExportsCenterUsingSwappedWidthHeight", TileShipBuilder_RotatedConstructionBench_ExportsCenterUsingSwappedWidthHeight),
        ("Ship_FromCustomDefinition_RotatedHelmAndNavigation_KeepTheirOwnRotatedFlag", Ship_FromCustomDefinition_RotatedHelmAndNavigation_KeepTheirOwnRotatedFlag),
        ...
        ("TileShipBuilder_TwoTileThickWallBetweenRooms_NeitherColumnIsDropped", TileShipBuilder_TwoTileThickWallBetweenRooms_NeitherColumnIsDropped),
        ("TileShipBuilder_TJunction_SpineCapAboveArm_StaysOpenAndGetsItsOwnWall", TileShipBuilder_TJunction_SpineCapAboveArm_StaysOpenAndGetsItsOwnWall),
        ("TileShipBuilder_HalfBlockNotchAtRegionEdge_StaysOpenAndKeepsItsWallOpenSide", TileShipBuilder_HalfBlockNotchAtRegionEdge_StaysOpenAndKeepsItsWallOpenSide),
        ("World_HalfBlockNotch_ClientRenderMatchesServerCollisionAtEveryNotchTile", World_HalfBlockNotch_ClientRenderMatchesServerCollisionAtEveryNotchTile),
        ("TileShipBuilder_LShapedRegion_DecomposesAndConnectsWithDoor", TileShipBuilder_LShapedRegion_DecomposesAndConnectsWithDoor),
        ("TileShipBuilder_RecessedTerminal_ExportsAsTerminalDeviceAtTileCenter", TileShipBuilder_RecessedTerminal_ExportsAsTerminalDeviceAtTileCenter),
        ("TileShipBuilder_MultipleTerminals_EachExportsAsItsOwnDevice", TileShipBuilder_MultipleTerminals_EachExportsAsItsOwnDevice),
        ("TileShipBuilder_WallLamp_ExportsAsWallLampDeviceAlongsideTerminal", TileShipBuilder_WallLamp_ExportsAsWallLampDeviceAlongsideTerminal),
        ("NonRectangularRoom_Validator_DoesNotFalselyFlagOverlapInsideItsOwnNotch", NonRectangularRoom_Validator_DoesNotFalselyFlagOverlapInsideItsOwnNotch),
        ("NonRectangularRoom_Validator_StillRejectsGenuineOverlapWithASubrect", NonRectangularRoom_Validator_StillRejectsGenuineOverlapWithASubrect),
        ...
        ("RectilinearDecomposition_NotchedCorners_DecomposesCleanly", RectilinearDecomposition_NotchedCorners_DecomposesCleanly),
        ("RectilinearDecomposition_UShape_DecomposesCleanly", RectilinearDecomposition_UShape_DecomposesCleanly),
        ("RectilinearDecomposition_ManyPiecesShape_StillDecomposesCleanly", RectilinearDecomposition_ManyPiecesShape_StillDecomposesCleanly),
        ("RectilinearDecomposition_Idempotent_OnItsOwnOutput", RectilinearDecomposition_Idempotent_OnItsOwnOutput),
        ("RectilinearDecomposition_EmptyShape_FailsCleanly", RectilinearDecomposition_EmptyShape_FailsCleanly),
        ("World_Fabricator_CraftsSteelPlate_ConsumesIngredientsAndProducesOutput", World_Fabricator_CraftsSteelPlate_ConsumesIngredientsAndProducesOutput),
        ("World_Fabricator_RefusesWithoutEnoughIngredients", World_Fabricator_RefusesWithoutEnoughIngredients),
        ("World_Fabricator_RefusesWhenFarFromDevice", World_Fabricator_RefusesWhenFarFromDevice),
        ("World_Fabricator_CraftsTitaniumPlate_FromOreAndARefinedIngredient", World_Fabricator_CraftsTitaniumPlate_FromOreAndARefinedIngredient),
        ("World_Deconstructor_ReversesSteelPlateIntoItsOwnIngredients", World_Deconstructor_ReversesSteelPlateIntoItsOwnIngredients),
        ("World_Deconstructor_RefusesARawOreWithNoRecipe", World_Deconstructor_RefusesARawOreWithNoRecipe),
        ("World_Production_CancelPressed_StopsTimerWithoutConsumingAnything", World_Production_CancelPressed_StopsTimerWithoutConsumingAnything),
        ("World_ClickInteract_Terminal_TogglesOnlyTheOneClicked", World_ClickInteract_Terminal_TogglesOnlyTheOneClicked),
        ...
        ("Door_IsVertical_UsesExplicitFieldWhenGiven", Door_IsVertical_UsesExplicitFieldWhenGiven),
        ("Door_IsVertical_FallsBackToWidthHeightWhenOmitted", Door_IsVertical_FallsBackToWidthHeightWhenOmitted),
        ("Door_FootprintRect_NarrowDoorIsOneByTwoTiles", Door_FootprintRect_NarrowDoorIsOneByTwoTiles),
        ("Door_FootprintRect_WideDoorIsTwoByTwoTiles", Door_FootprintRect_WideDoorIsTwoByTwoTiles),
        ("CustomDeviceFootprint_HelmAndNavigation_ReserveTwoByTwoForCollision", CustomDeviceFootprint_HelmAndNavigation_ReserveTwoByTwoForCollision),
        ("TileGrid_IsWalkable_OrdinaryDevice_BlocksBothHalves", TileGrid_IsWalkable_OrdinaryDevice_BlocksBothHalves),
        ("TileGrid_IsWalkable_StandaloneHalfWidthDevice_BlocksOnlyItsOwnHalf", TileGrid_IsWalkable_StandaloneHalfWidthDevice_BlocksOnlyItsOwnHalf),
        ("TileGrid_IsWalkable_HalfBlockWallAlone_OnlyItsOwnHalfIsBlocked", TileGrid_IsWalkable_HalfBlockWallAlone_OnlyItsOwnHalfIsBlocked),
        ("TileGrid_IsWalkable_HalfBlockWallWithWallDevice_BlocksEverywhere", TileGrid_IsWalkable_HalfBlockWallWithWallDevice_BlocksEverywhere),
        ("TileGrid_IsWalkable_HalfBlockWallCoexistingWithHalfWidthDevice_BlocksWholeTile", TileGrid_IsWalkable_HalfBlockWallCoexistingWithHalfWidthDevice_BlocksWholeTile),
        ("TileMovement_MoveAlongAxis_StandaloneHalfWidthDevice_StopsAtRealOneAndAHalfTileBoundary", TileMovement_MoveAlongAxis_StandaloneHalfWidthDevice_StopsAtRealOneAndAHalfTileBoundary),
        ("TileMovement_MoveAlongAxis_HalfBlockWallCoexistingWithHalfWidthDevice_BlocksTheFormerlyOpenHalfToo", TileMovement_MoveAlongAxis_HalfBlockWallCoexistingWithHalfWidthDevice_BlocksTheFormerlyOpenHalfToo),
        ("TileGrid_CanPlaceHalfWidthDevice_SucceedsOnOpenFloor", TileGrid_CanPlaceHalfWidthDevice_SucceedsOnOpenFloor),
        ("TileGrid_PlaceHalfWidthDevice_StandaloneOnOpenFloor_SetsDeviceIdAndOpenSide", TileGrid_PlaceHalfWidthDevice_StandaloneOnOpenFloor_SetsDeviceIdAndOpenSide),
        ("TileGrid_CanPlaceHalfWidthDevice_SucceedsOnMatchingHalfBlockWall", TileGrid_CanPlaceHalfWidthDevice_SucceedsOnMatchingHalfBlockWall),
        ("TileGrid_PlaceHalfWidthDevice_OnHalfBlockWall_PreservesWallFieldsUnchanged", TileGrid_PlaceHalfWidthDevice_OnHalfBlockWall_PreservesWallFieldsUnchanged),
        ("TileGrid_CanPlaceHalfWidthDevice_RejectsMismatchedHalfBlockWallOpenSide", TileGrid_CanPlaceHalfWidthDevice_RejectsMismatchedHalfBlockWallOpenSide),
        ("TileGrid_CanPlaceHalfWidthDevice_RejectsFullThicknessWall", TileGrid_CanPlaceHalfWidthDevice_RejectsFullThicknessWall),
        ("TileGrid_CanPlaceHalfWidthDevice_RejectsTileAlreadyClaimedByNeighborsHalf", TileGrid_CanPlaceHalfWidthDevice_RejectsTileAlreadyClaimedByNeighborsHalf),
        ("TileGrid_RemoveDevice_ClearsDeviceOpenSide_LeavesCoexistingWallUntouched", TileGrid_RemoveDevice_ClearsDeviceOpenSide_LeavesCoexistingWallUntouched),
        ("TileShipBuilder_HelmWallAdjacentPlacement_RoundTripsThroughShip_WallSurvivesUnchanged", TileShipBuilder_HelmWallAdjacentPlacement_RoundTripsThroughShip_WallSurvivesUnchanged),
        ("Ship_FromCustomDefinition_OldStyleHelmNavigation_StillBuildsFromFrozenHull", Ship_FromCustomDefinition_OldStyleHelmNavigation_StillBuildsFromFrozenHull),
    };
