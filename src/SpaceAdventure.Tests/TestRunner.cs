...
internal static partial class TestRunner
{
    private static readonly (string Name, Func<bool> Run)[] Tests =
    {
        ...
        ("CompartmentCatalog_RotationTransform_MatchesHandComputedCoordinates", CompartmentCatalog_RotationTransform_MatchesHandComputedCoordinates),
        ("CompartmentCatalog_EngineSmall1Way_HasNonOverlappingValidLayout", CompartmentCatalog_EngineSmall1Way_HasNonOverlappingValidLayout),
        ("CompartmentCatalog_EngineSmall2Way_HasNonOverlappingValidLayout", CompartmentCatalog_EngineSmall2Way_HasNonOverlappingValidLayout),
        ("CompartmentCatalog_EngineSmall3Way_HasNonOverlappingValidLayout", CompartmentCatalog_EngineSmall3Way_HasNonOverlappingValidLayout),
        ...
        ("CompartmentEditor_TouchingCompartments_StillDedupToExactlyOneWallTile", CompartmentEditor_TouchingCompartments_StillDedupToExactlyOneWallTile),
        ("CompartmentEditor_RemovingCompartment_RepairsNeighborsDedupedWall", CompartmentEditor_RemovingCompartment_RepairsNeighborsDedupedWall),
        ("CompartmentEditor_RemovingCompartment_ClearsEveryFootprintTileToNoFloor", CompartmentEditor_RemovingCompartment_ClearsEveryFootprintTileToNoFloor),
        ("CompartmentDoors_ValidBoundarySpan_ResolvesToCorrectNeighborPair", CompartmentDoors_ValidBoundarySpan_ResolvesToCorrectNeighborPair),
        ("CompartmentDoors_WallBorderingOpenSpace_IsRejected", CompartmentDoors_WallBorderingOpenSpace_IsRejected),
        ("CompartmentDoors_CornerTile_IsRejected", CompartmentDoors_CornerTile_IsRejected),
        ("CompartmentDoors_Removal_RestoresSolidForCompartmentBoundaryButNoneForOrdinaryDoor", CompartmentDoors_Removal_RestoresSolidForCompartmentBoundaryButNoneForOrdinaryDoor),
        ("CompartmentProtection_CoreDeviceTile_IsProtectedButNonCoreIsNot", CompartmentProtection_CoreDeviceTile_IsProtectedButNonCoreIsNot),
